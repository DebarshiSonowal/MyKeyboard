...
public class Main3Activity extends AppIntro2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("Welcome to গড়গঞাঁ অসমীয়া Typing app","This is a typing app with a custom Assamese font keyboard that enables you to write in Assamese in android phones",R.drawable.ic_app_icon_garhgaya_asomiya, Color.parseColor("#252525")));
